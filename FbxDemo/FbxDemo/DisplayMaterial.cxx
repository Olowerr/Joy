...
void DisplayMaterial(FbxGeometry* pGeometry)
{
    ...
    if (lMaterialCount > 0)
    {
        ...
        {
            Writer::AddMaterial(lNode->GetMaterial(i)->GetName());
        }
        ...
        for (int lCount = 0; lCount < lMaterialCount; lCount ++)
        {
            ...
            Writer::SetMaterial(pGeometry->GetNode()->GetName(), lMaterial->GetName());
            ...
            else if (lMaterial->GetClassId().Is(FbxSurfacePhong::ClassId))
            {
                ...
                Writer::SetMatAmbient((float)lKFbxDouble3.Get()[0], (float)lKFbxDouble3.Get()[1], (float)lKFbxDouble3.Get()[2]);

                // Display the Diffuse Color
                lKFbxDouble3 =((FbxSurfacePhong *) lMaterial)->Diffuse;
                theColor.Set(lKFbxDouble3.Get()[0], lKFbxDouble3.Get()[1], lKFbxDouble3.Get()[2]);
                DisplayColor("            Diffuse: ", theColor);
                Writer::SetMatDiffuse((float)lKFbxDouble3.Get()[0], (float)lKFbxDouble3.Get()[1], (float)lKFbxDouble3.Get()[2]);

                // Display the Specular Color (unique to Phong materials)
                lKFbxDouble3 =((FbxSurfacePhong *) lMaterial)->Specular;
                theColor.Set(lKFbxDouble3.Get()[0], lKFbxDouble3.Get()[1], lKFbxDouble3.Get()[2]);
                DisplayColor("            Specular: ", theColor);
                Writer::SetMatSpecular((float)lKFbxDouble3.Get()[0], (float)lKFbxDouble3.Get()[1], (float)lKFbxDouble3.Get()[2]);

                // Display the Emissive Color
                lKFbxDouble3 =((FbxSurfacePhong *) lMaterial)->Emissive;
                theColor.Set((float)lKFbxDouble3.Get()[0], (float)lKFbxDouble3.Get()[1], (float)lKFbxDouble3.Get()[2]);
